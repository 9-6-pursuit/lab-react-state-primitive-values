...
export default function Game ({setWin, setScore, setInc, inc, score}) {
    ...
    function increaseScore(score, setScore, setInc, inc){
    ...
    return (
        ...
        <button key="grandma" onClick={() => increaseScore(score, setScore, setInc, inc)}>Pay 10 points to change from +{inc} to +{inc +1}</button> </>
         )
}